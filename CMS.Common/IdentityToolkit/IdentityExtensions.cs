...
namespace CMS.Common.IdentityToolkit
{
    /// <summary>
    ...
    public static class IdentityExtensions
    {
        ...
        public static bool GetUserDebitStat(this IIdentity identity)
        {
            if (identity != null)
            {
                bool.TryParse(identity.GetUserClaimValue("IsDebitUser"), out bool stat);
        ...
        public static bool IsSystemUser(this IIdentity identity)
        {
            if (identity != null)
            {
                bool.TryParse(identity.GetUserClaimValue("IsSystemUser"), out bool stat);
